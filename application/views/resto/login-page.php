          ...
          <div class="carousel-item active" style="background:url(<?php echo base_url('assets/img/bg3.jpg')?>);">
            <div class="carousel-container">
              <div class="carousel-content">
                ...
                <div>
                  <a href="<?= base_url() ?>Login" class="btn-menu animate__animated animate__fadeInUp">Masuk</a>
                  <a href="<?= base_url() ?>Register" class="btn-book animate__animated animate__fadeInUp">Daftar</a>
                </div>
              </div>
